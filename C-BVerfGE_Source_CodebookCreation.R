...
#' praesi & String & (Nur CSV-Datei) Der Nachname des oder der PräsidentIn in dessen/deren Amtszeit das Datum der Entscheidung fällt.\\
#' v\_praesi & String & (Nur CSV-Datei) Der Nachname des oder der Vize-PräsidentIn in dessen/deren Amtszeit das Datum der Entscheidung fällt.\\
